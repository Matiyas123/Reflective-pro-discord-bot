...
module.exports = class BanCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    if (!mentionedMember) return message.channel.send("The member mentioned is not inthe server.");
    if (!mentionedMember.bannable) return message.channel.send("I can't ban that member.");
